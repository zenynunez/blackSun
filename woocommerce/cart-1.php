...
<table class="shop_table table cart" cellspacing="0">
	<thead>
		<tr>
			...
			<th class="product-name"><?php _e( 'Producto', ETHEME_DOMAIN ); ?></th>
			<th class="product-price a-center"><?php _e( 'Precio', ETHEME_DOMAIN ); ?></th>
			<th class="product-quantity hidden-phone a-center"><?php _e( 'Cantidad', ETHEME_DOMAIN ); ?></th>
	...
	<tbody>
		...
		<tr>
			<td colspan="6" class="actions">
				...
				<input type="submit" class="button" name="update_cart" value="<?php _e( 'Actualizar', ETHEME_DOMAIN ); ?>" /> 
...
<?php do_action( 'woocommerce_after_cart_table' ); ?>
	...
	<div class="span4 cart-totals-section">
		<div class="cart-totals-block">
			...
			<a href="<?php echo esc_url( $woocommerce->cart->get_checkout_url() ); ?>" class="fl-r arrow-right checkout-button button big"><span><?php _e('Proceder a pagar', ETHEME_DOMAIN); ?></span></a>  

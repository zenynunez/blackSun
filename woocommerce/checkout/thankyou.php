...
if ( $order ) : ?>
	...
	<?php if ( in_array( $order->status, array( 'failed' ) ) ) : ?>
		...
		<p>
			...
			<a href="<?php echo esc_url( get_permalink( woocommerce_get_page_id( 'myaccount' ) ) ); ?>" class="button pay"><?php _e( 'Mi Cuenta', ETHEME_DOMAIN ); ?></a>
			<?php endif; ?>
		</p>

	<?php else : ?>

		<p><?php _e( 'Gracias. Su pedido ha sido recibido.', ETHEME_DOMAIN ); ?></p>

		<ul class="order_details">
			<li class="order">
				<?php _e( 'Orden:', ETHEME_DOMAIN ); ?>
				<strong><?php echo $order->get_order_number(); ?></strong>
			</li>
			<li class="date">
				<?php _e( 'Fecha:', ETHEME_DOMAIN ); ?>
			...
			<li class="method">
				<?php _e( 'Método de pago:', ETHEME_DOMAIN ); ?>

    ...
    function etheme_init() {
        ...
        ?>
            ...
            <script type="text/javascript">
                ...
                var successfullyAdded = '<?php _e('Se agrego exitosamente a tu carrito', ETHEME_DOMAIN) ?>';
                ...
                <?php if (class_exists('WooCommerce')) {
                    ...
                    ?>
                        ...
                        var contBtn = '<?php _e('Continuar Comprando', ETHEME_DOMAIN) ?>';
                        var checkBtn = '<?php _e('Pagar', ETHEME_DOMAIN) ?>';
                    <?php
                } ?>
        ...
        ?>
            <ul class="links">
                <?php if ( is_user_logged_in() ) : ?>
                    <?php if(class_exists('Woocommerce')): ?> <li class="my-account-link"><a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"><?php _e( 'Tu Cuenta', ETHEME_DOMAIN ); ?></a>
                    <div class="submenu-dropdown">
                        ...
                        <li class="logout-link"><a href="<?php echo wp_logout_url(home_url()); ?>"><?php _e( 'Salir', ETHEME_DOMAIN ); ?></a></li>
                <?php else : ?>
                    <?php 
                        $reg_id = etheme_tpl2id('et-registration.php'); 
                        $reg_url = get_permalink($reg_id);
                    ?>    
                    <?php if(class_exists('Woocommerce')): ?><li class="login-link"><a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"><?php _e( 'Entrar', ETHEME_DOMAIN ); ?></a></li><?php endif; ?>
                    <?php if(!empty($reg_id)): ?><li class="register-link"><a href="<?php echo $reg_url; ?>"><?php _e( 'Registrarse', ETHEME_DOMAIN ); ?></a></li><?php endif; ?>
                <?php endif; ?>
            </ul>
        <?php
    }
        ...
        ?>
            ...
            <div id="etheme-popup" class="white-popup-block mfp-hide">
                ...
                <p class="checkbox-label">
                    ...
                    <label for="showagain"><?php _e('No mostrar este popup otra vez', ETHEME_DOMAIN); ?></label>
                </p>
            </div>
            <style type="text/css">
                #etheme-popup {
